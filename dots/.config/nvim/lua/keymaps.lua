...
keymap("n", "gr", "<cmd> FzfLua lsp_references<cr>", { desc = "References", nowait = true })
keymap("n", "gI", "<cmd> FzfLua lsp_implementations<cr>", { desc = "Goto Implementation" })
keymap("n", "gy", "<cmd> FzfLua lsp_definitions<cr>", { desc = "Goto T[y]pe Definition" })
